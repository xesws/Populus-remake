...
import { Boathouse } from "./buildings/boathouse";
...
export function createUnit(id: number, team: Owner, kind: UnitKind, x: number, z: number, y: number, str = 1): Unit {
  ...
  switch (kind) {
    ...
    case "boat":
      return new Boat(id, team, x, z, y, hp, hp, str);
  }
}
...
export function createBuilding(
  ...
  switch (kind) {
    ...
    case "dragonFactory":
      ...
      break;
    case "boathouse":
      b = new Boathouse(id, team, x, z, y, finalHp, finalMaxHp, level, yaw, padW, padD, finalNeed);
      break;
  }
  return b;
}
